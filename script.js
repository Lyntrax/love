...
gsap.fromTo("#projects .section-title", 
    { y: 40, opacity: 0 },
    { scrollTrigger: { trigger: "#projects", start: "top 80%" }, y: 0, opacity: 1, duration: 0.8, immediateRender: false }
);
...
gsap.fromTo("#skills .section-title", 
    { y: 40, opacity: 0 },
    { scrollTrigger: { trigger: "#skills", start: "top 80%" }, y: 0, opacity: 1, duration: 0.8, immediateRender: false }
);
gsap.fromTo(".skill-card", 
    { y: 50, opacity: 0 },
    { scrollTrigger: { trigger: "#skills", start: "top 80%" }, y: 0, opacity: 1, stagger: 0.1, duration: 0.8, immediateRender: false }
);
gsap.fromTo(".contact-layout", 
    { y: 40, opacity: 0 },
    { scrollTrigger: { trigger: "#contact", start: "top 80%" }, y: 0, opacity: 1, duration: 0.8, immediateRender: false }
);
...
toggleBtn.addEventListener('click', () => {
  ...
  toggleBtn.innerHTML = newDark ? '<i class="fas fa-sun"></i>' : '<i class="fas fa-moon"></i>';
...
if (viewWork) {
    viewWork.addEventListener('click', () => scrollToSection('projects'));
}

if (contactHero) {
    contactHero.addEventListener('click', () => scrollToSection('contact'));
}
